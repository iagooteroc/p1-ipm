...
class AppWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        #Resizing all the boxes to GIHG
        self.box.set_spacing(6)
        self.inbox.set_spacing(6)
        self.treeviewbox.set_spacing(12)
...
class DialogEdit(Gtk.Dialog):
    def __init__(self, parent, model, iter):
        ...
        self.newbox  = Gtk.Box()
        self.newbox.set_spacing(6)
        labelbox = Gtk.Box(orientation=Gtk.Orientation.VERTICAL)
        entrybox = Gtk.Box(orientation=Gtk.Orientation.VERTICAL)
        labelbox.set_spacing(6)
        entrybox.set_spacing(6)
        
        self.box.pack_start(self.newbox, True, False, 0)
        self.newbox.pack_start(labelbox, True, False, 0)
        self.newbox.pack_start(entrybox, True, False, 0)
        ...
        entrybox.pack_start(self.entryName, True, True, 0)
        ...
        entrybox.pack_start(self.entryDate, True, True, 0)
        ...
        entrybox.pack_start(self.entryRating, True, True, 0)
        self.show_all()
